...
pie(gender_counts, main = "Gender Proportions")
...
pie(budgetarydecision_count, main = "Do You Participate in Budgetary Decisions?")
...
plot(as.numeric(Typical_Employee_Survey_Data$PromotionLikelihood), Typical_Employee_Survey_Data$Age, main = "Likelihood of Promotion vs. Age", xlab = "Promotion Likelihood (1 being very likely and 5 being very unlikely", ylab = "Age", col = "Purple")
